...
dependencies:
  tools:
    - name: sequential-thinking
      description: "Required — structured hypothesis formation and ranking via sequentialthinking"
    - name: jcodemunch
      description: "Optional — code structure analysis: get_context_bundle, find_references, get_blast_radius, get_symbol_source, search_text, index_file, and more"
description: >

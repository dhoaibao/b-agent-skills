...
dependencies:
  tools:
    - name: brave-search
      description: "Required — web and news search for fast single-call lookups via brave_web_search and brave_news_search"
description: >
...
"❌ brave-search MCP is not connected. Please check `codex mcp list`."

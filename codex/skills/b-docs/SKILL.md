...
dependencies:
  tools:
    - name: context7
      description: "Required — fetch versioned, accurate library documentation via resolve-library-id and query-docs"
description: >
...
- Tell the user: "❌ context7 MCP is not connected. Please check `codex mcp list`.".

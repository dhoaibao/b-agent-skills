...
dependencies:
  tools:
    - name: jcodemunch
      description: "Required — code structure analysis: index_folder, suggest_queries, get_repo_outline, get_file_outline, get_symbol_source, get_dependency_graph, search_symbols, find_importers, check_references, get_class_hierarchy, get_related_symbols, search_text"
    - name: sequential-thinking
      description: "Optional — structured prioritization of findings to produce an ordered action list"
description: >

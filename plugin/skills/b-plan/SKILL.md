...
- Claude Code compaction and session context - recover prior planning context when available.

## Steps

1. State the interpreted goal, constraints, and non-goals. Use Claude Code compaction/session context when compacted prior planning ids are available.

...
|---|---|---|
| `b-agentic-preview-markdown.ts` | Inline default-dark export-style Markdown cards with `ctrl+shift+m` copying the latest source | Default; installed and configured by b-agentic |

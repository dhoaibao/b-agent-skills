...
- `--sync` pulls the installed checkout and syncs managed b-agentic assets
- `--update` upgrades installed RTK, Serena, CodeGraph, Pi, and Pi extensions without pulling b-agentic

...
description: >
  Repository and design-conformance audit for b-agentic. Compares the
  evidence-backed decision record with canonical sources, generated
  assets, workflow, safety, install, tooling, and verification behavior,
  and reports drift without replacing separate diff checks.
---

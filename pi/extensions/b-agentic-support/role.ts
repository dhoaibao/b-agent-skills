...
export const SKILL_OWNERSHIP_CRITERION = "Architect-owned skills perform read-only planning, research, audit, or changed-code review. Executor-owned skills perform design, implementation, validation, commit, or PR-summary work. Mixed or uncertain skills are executor-owned.";
...
- When a request or skill route requires b-plan or b-research, do not execute that Architect-owned work; route to the Architect by requesting it through intercom from the compatible same-CWD Architect when available, otherwise tell the user that an Architect session must handle it; remain stopped until an approved-plan handoff or research result arrives.
...
- Independently assess the compact candidate handoff, actual diff, relevant untracked/derived files, acceptance baseline, and verification evidence. When an executor handoff arrives through intercom, begin b-review automatically. Do not accept a missing baseline, stale or different snapshot, incompatible peer, skipped/failed required check, or unaccepted follow-up as ready.
...
- Planning or research completion is not implementation, task acceptance, commit creation, or shipping. Review completion is not task acceptance, commit creation, or shipping. Never claim or provision fresh context: architect selection and freshness are runtime/user concerns outside this profile. Finish b-review with the required disposition for the exact snapshot only after the handback succeeds or its coordination gap is reported.`;

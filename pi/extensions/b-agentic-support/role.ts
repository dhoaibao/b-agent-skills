...
- When the explicit implementer role is active and implementation is complete with required checks passed, use intercom list-cwd to identify the reviewer session in the same CWD permitted by role arbitration, then automatically request independent b-review through intercom with a compact snapshot handoff and stop edits. If that reviewer or intercom capability is unavailable, report the coordination gap and stop; never provision, reset, or guess a peer.

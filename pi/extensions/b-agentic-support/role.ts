...
- If a successful, structurally valid consultation materially changes a hard decision, cite it only as one concise natural-language \`Consultation\` note in the plan or worker handoff: include the question, recommendation or trade-off, risks or missing evidence, and how repository evidence was weighed. Keep the note optional and minimal, treat it as advisory rather than evidence, and introduce no artifact, store, command, or template for it; omit it when it does not materially change the decision.

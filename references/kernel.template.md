...
- Use natural language. Handoffs cover applicable observable behavior, scope/non-goals, constraints/invariants, evidence, acceptance, validation, gaps. Worker results give implemented behavior, changed paths, acceptance coverage, exact checks/outcomes, deviations; request actual `b-review`, then pause.
